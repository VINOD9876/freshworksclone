...
import './Totalcss.css'
export default function Belowfourth(){
    return(
        <section className="pb-xl section-light-grey " >
      ...
      <div className="carousel-item item active">
        <div className="row testimonial-card all-center">
          <div className="col-md-12 testimonial-content">
            ...
            <p className="testimonial-quote">“The Freshworks team was a great asset during implementation and continue to be a key partner for Waterstons as we look to further mature and improve our services to customers, tailored to their specific needs.”</p>
            <div className="col-md-10 col-md-offset-1 author-bio">
                <h6 className="author-name">Alex Bookless, Head of Managed Services, Waterstons</h6>
            </div>
          </div>
        </div>
      </div>
      <div className="carousel-item item ">
        <div className="row testimonial-card all-center">
          <div className="col-md-12 testimonial-content">
            ...
            <p className="testimonial-quote">“For PhonePe, Freddy fetches context from the transactions made and offers contextual assistance for a personalized self-service experience from right within the app. We have been using it for a year and can confidently say that we have accomplished most of what we had in mind.”</p>
            <div className="col-md-10 col-md-offset-1 author-bio">
                <h6 className="author-name">Vishal Gupta, Head of Product, PhonePe</h6>
            </div>
          </div>
        </div>
      </div>
      <div className="carousel-item item ">
        <div className="row testimonial-card all-center">
          <div className="col-md-12 testimonial-content">
            ...
            <div className="col-md-10 col-md-offset-1 author-bio">
                <h6 className="author-name">Alex Anheuer, Manager Workplace Services, Payvision</h6>
            </div>
          </div>
        </div>
      </div>
